...
window.environment.model = "desktop"
if (navigator.userAgent.includes("android")) {window.environment.model = "AndroidTV"};
if (navigator.userAgent.includes("PLAYSTATION") || navigator.userAgent.includes("PlayStation")) {window.environment.model = "ps3"};
